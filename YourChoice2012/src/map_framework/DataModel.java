...
public class DataModel {
	 ...
	 **/
	public void highlightMapRegion(Renderer renderer, int x, int y)
	{
		boolean polySelected = selectPolygonAt(renderer,x, y);
		if (!polySelected)
		{
	 ...
	 * false is returned. 
	 **/
	public boolean selectPolygonAt(Renderer renderer, int x, int y)
	{
